  ...
  const getTechColor = (tech: string) => {
    const techColors: Record<string, any> = {
      ...
      'AWS Lambda': {
        ...
        hover: 'hover:bg-amber-400/20 hover:border-amber-400',
      ...
      'Amazon Connect': {
        ...
        hover: 'hover:bg-rose-400/20 hover:border-rose-400',
        glow: 'hover:shadow-rose-400/30',
      },
      'CloudWatch': {
        bg: 'bg-cyan-400/10',
        text: 'text-cyan-400',
        border: 'border-cyan-400/50',
        hover: 'hover:bg-cyan-400/20 hover:border-cyan-400',
      ...
      'Amazon Q': {
        ...
        hover: 'hover:bg-purple-400/20 hover:border-purple-400',
      ...
      'DynamoDB': {
        ...
        hover: 'hover:bg-sky-400/20 hover:border-sky-400',
      ...
      'Python': {
        ...
        hover: 'hover:bg-yellow-400/20 hover:border-yellow-400',
